		...
		It("should use individual service certificate paths when no custom CA bundle", func() {
			...
			featureStore := &feastdevv1alpha1.FeatureStore{
				Status: feastdevv1alpha1.FeatureStoreStatus{
					...
					Applied: feastdevv1alpha1.AppliedFeatureStoreSpec{
						Services: feastdevv1alpha1.Services{
							OfflineStore: &feastdevv1alpha1.OfflineStore{
								Server: &feastdevv1alpha1.OfflineServer{
							...
							OnlineStore: &feastdevv1alpha1.OnlineStore{
								Server: &feastdevv1alpha1.OnlineServer{
									TLS: &feastdevv1alpha1.TlsConfigs{
							...
							Registry: &feastdevv1alpha1.Registry{
								Local: &feastdevv1alpha1.LocalRegistry{
									Server: &feastdevv1alpha1.RegistryServer{
										TLS: &feastdevv1alpha1.TlsConfigs{
